...
abstract class AppLocalizations {
  ...
  /// No description provided for @recommendationFound.
  ///
  /// In en, this message translates to:
  /// **'Recommendation Found'**
  String get recommendationFound;

  /// No description provided for @resultBasedOnAcr.
  ///
  /// In en, this message translates to:
  /// **'Based on ACR Appropriateness Criteria'**
  String get resultBasedOnAcr;

  /// No description provided for @acr.
  ///
  /// In en, this message translates to:
  /// **'ACR'**
  String get acr;
  ...
  /// No description provided for @radiationLevel.
  ///
  /// In en, this message translates to:
  /// **'Radiation: {level}'**
