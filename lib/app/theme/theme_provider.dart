...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        colorScheme: const ColorScheme.light(
          ...
          onSecondary: AppColorPalette.onSecondaryLight,
          secondaryContainer: AppColorPalette.secondaryContainerLight,
          onSecondaryContainer: AppColorPalette.onSecondaryContainerLight,
          ...
          surfaceContainerLowest: AppColorPalette.surfaceContainerLowestLight,
          surfaceContainerLow: AppColorPalette.surfaceContainerLowLight,
          surfaceContainer: AppColorPalette.surfaceContainerLight,
          surfaceContainerHigh: AppColorPalette.surfaceContainerHighLight,
          surfaceContainerHighest: AppColorPalette.surfaceContainerHighestLight,
          error: AppColorPalette.errorLight,
          onError: AppColorPalette.onErrorLight,
          errorContainer: AppColorPalette.errorContainerLight,
          onErrorContainer: AppColorPalette.onErrorContainerLight,
          outline: AppColorPalette.outlineLight,
          outlineVariant: AppColorPalette.outlineVariantLight,
        ),
        scaffoldBackgroundColor: AppColorPalette.surfaceLight,
        ...
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          backgroundColor: AppColorPalette.surfaceContainerLowestLight,
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        colorScheme: const ColorScheme.dark(
          ...
          onSecondary: AppColorPalette.onSecondaryDark,
          secondaryContainer: AppColorPalette.secondaryContainerDark,
          onSecondaryContainer: AppColorPalette.onSecondaryContainerDark,
          ...
          surfaceContainerLowest: AppColorPalette.surfaceContainerLowestDark,
          surfaceContainerLow: AppColorPalette.surfaceContainerLowDark,
          surfaceContainer: AppColorPalette.surfaceContainerDark,
          surfaceContainerHigh: AppColorPalette.surfaceContainerHighDark,
          surfaceContainerHighest: AppColorPalette.surfaceContainerHighestDark,
          error: AppColorPalette.errorDark,
          onError: AppColorPalette.onErrorDark,
          errorContainer: AppColorPalette.errorContainerDark,
          onErrorContainer: AppColorPalette.onErrorContainerDark,
          outline: AppColorPalette.outlineDark,
          outlineVariant: AppColorPalette.outlineVariantDark,
        ),
        scaffoldBackgroundColor: AppColorPalette.surfaceDark,
        ...
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          backgroundColor: AppColorPalette.surfaceContainerLowestDark,
